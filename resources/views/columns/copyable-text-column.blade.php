...
>
    ...
    <button @click.prevent="$clipboard( '{{$getFormattedState()}}')">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-primary-700 dark:text-primary-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
